...
/**
 * Collection of methods to convert special and extended
...
public class HTMLEntities {
	 ...
	 */
	private final Object[][] html_entities_table = {
	 ...
	 */
	private final Hashtable htmlentities_map = new Hashtable();
	
	/**
	 * Map to convert html entities in exteden characters.
	 */
	private final Hashtable unhtmlentities_map = new Hashtable();
	 ...
	 */
	private void initializeEntitiesTables() {
		// initialize html translation maps
	 ...
	 */
	public Object[][] getEntitiesTable() {
	...
	public String unhtmlentities(String str) {
		...
		String ok = this.unhtmlQuotes(buf.toString());
		ok = this.unhtmlAmpersand(ok);
		return ok;
	}
	 ...
	 */
	public String htmlSingleQuotes(String str) {
	 ...
	 * @return string with replaced single quotes
	 */
	public String unhtmlSingleQuotes(String str) {
	 ...
	 */
	public String htmlDoubleQuotes(String str) {
		str = str.replaceAll("[\"]", "&quot;");
		str = str.replaceAll("&#147;", "&quot;");
		str = str.replaceAll("&#148;", "&quot;");
		return str;
	 ...
	 * @return string with replaced single quotes
	 */
	public String unhtmlDoubleQuotes(String str) {
	 ...
	 */
	public String htmlQuotes(String str) {
	 ...
	 * @return string with replaced quotes
	 */
	public String unhtmlQuotes(String str) {
	 ...
	 */
	public String htmlAngleBrackets(String str) {
		str = str.replaceAll("<", "&lt;");
		str = str.replaceAll(">", "&gt;");
		return str;
	}
	 ...
	 */
	public String unhtmlAngleBrackets(String str) {
		str = str.replaceAll("&lt;", "<");
		str = str.replaceAll("&gt;", ">");
		return str;
	}
	 ...
	 * @return string with replaced characters
	 */
	public String htmlAmpersand(String str) {
		return str.replaceAll("&", "&amp;");
	}
	 ...
	 * @return string with replaced entities
	 */
	public String unhtmlAmpersand(String str) {
		return str.replaceAll("&amp;", "&");
	}
